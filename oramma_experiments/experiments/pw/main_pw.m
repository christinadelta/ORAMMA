% ORAMMA EXPERIMENTS:PASSIVE VIEWING Simple version (version 1)
...
% This script runs the passive viewing task
...
try
    ...
    DrawFormattedText(instructions, 'you will be presented with animate and inanimate objects. At random moments', 'center', scrn.ycenter-50, scrn.white);
    DrawFormattedText(instructions, 'a paperclip in white background will appear. Your task is keep fixating at the', 'center', 'center', scrn.white);
    DrawFormattedText(instructions, 'center of the screen and press the "Left Arrow" key whenever the paperclip appears.','center', scrn.ycenter+50, scrn.white);
    DrawFormattedText(instructions, 'Press SPACE if you have understood the instructions.','center', scrn.ycenter+100, scrn.white);
