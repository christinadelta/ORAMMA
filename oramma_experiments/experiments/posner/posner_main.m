% ORAMMA EXPERIMENTS: POSNER CUEING TASK Simple version (version 1)
...
% This script runs a simple posner cueing task (introdused by M. Posner,
% 1980)
...
try
    ...
    DrawFormattedText(instructions, 'you will be briefly presented with an arrow (cue) at the center of the screen pointing towards,', 'center', scrn.ycenter-100, scrn.white);
    DrawFormattedText(instructions, 'left or right. After the cue a target will appear either at the left or the right of the center. When you see the', 'center', scrn.ycenter-50, scrn.white);
    DrawFormattedText(instructions, 'the target you need to respond as fast as possible indicating the position of the target.','center', 'center', scrn.white);
    DrawFormattedText(instructions, 'If the target appeared on the left side press the Left Arrow on your keyboard. If the target appeared on the right','center', scrn.ycenter+50, scrn.white);
    DrawFormattedText(instructions, 'side press the Right Arrow on your keyboard. Please respond as as possible in every trial.','center', scrn.ycenter+100, scrn.white);
